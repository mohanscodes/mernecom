...
const Card = () => {
  ...
  // navigate to other route with share some data name of state
  const redirect = () => {
    navigate("/shipping", {
      state: {
                    ...
                    {card_products.map((p, i) => (
                      <div key={i} className="flex bg-white p-4 flex-col gap-2">
                        <div className="flex justify-start items-center">
                          <h2 className="text-md text-[#2f2f2f]  font-bold">
                            {p.shopName}
                          </h2>
                        </div>
                        {p.products.map((pt, j) => (
                          <div key={j} className="w-full flex flex-wrap">
                            <div className="flex sm:w-full gap-2 w-7/12">
                              <div className="flex gap-2 justify-start items-center">
                                ...
                                />
                                <div className="pr-4 text-[#2f2f2f] ">
                            ...
                            <div key={i} className="w-full flex flex-wrap">
                              ...
                              <div className="flex justify-between w-5/12 sm:w-full sm:mt-3">
                                ...
                                <div className="flex gap-2 flex-col">
                                  ...
                                  <button onClick={() => dispatch(delete_card_product(p._id)) } className="px-5 py-[3px] bg-red-500 text-white">
                                    Delete
                                  </button>
                                </div>
                              </div>
              ...
              <div className="w-[33%] md-lg:w-full">
                <div className="pl-3 md-lg:pl-0 md-lg:mt-5">
                  {card_products.length > 0 && (
                    <div className="bg-white p-3 text-[#2f2f2f]  flex flex-col gap-3">
