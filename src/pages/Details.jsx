...
const Details = () => {
  ...
  return (
    <div className="bg-[#f7f4ef]">
      ...
      {/* page title start */}
      <section className='bg-[url("https://res.cloudinary.com/dxowg9liw/image/upload/v1722172070/shop_page_kctvs2.jpg")] h-[180px] bg-cover bg-no-repeat relative bg-left'>
      ...
      <section className="py-[50px]">
        <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] mx-auto">
          <div className="grid gap-5 grid-cols-2 md-lg:grid-cols-1 justify-center items-center">
            {/* product image slide */}
            <div className="flex items-end sm:items-center justify-center flex-col">
              <div className="border rounded-lg overflow-hidden w-[70%] sm:w-[100%] sm:w-full">
                <img
              ...
              <div className="pt-3 w-[70%] sm:w-[100%]">
                {product.images && (
                  <Carousel
                    autoPlay={true}
                    infinite={true}
                      ...
                      return (
                        <div key={i} onClick={() => setImage(img)}>
                          <img
                            className={
                              image == img
                                ? "h-auto w-[120px] object-cover cursor-pointer border-2 border-[#b89f7b]"
                                : "h-auto w-[120px] object-cover cursor-pointer"
                            }
                            src={img}
                            alt=""
                          />
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex gap-3 pb-10 border-b">
                {product.stock ? (
                  <>
                    <div className="flex border-2 h-[50px] justify-center items-center text-xl">
                      <div
                        onClick={dec}
                        className="px-6 cursor-pointer no-select"
                      >
                        -
                      </div>
              ...
              <div className="flex py-5 gap-5">
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <ul className="flex justify-start items-center gap-3">
                    <li>
                      <a
                        className="w-[38px] h-[38px] hover:bg-[#74463c] hover:text-white flex justify-center items-center bg-[#222222] rounded-full text-white"
                        href="#"
                      >
                        {" "}
                        <FaFacebookF />{" "}
      ...
      <section>
        <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] mx-auto">
          {/* left */}
          <div className="flex flex-col items-center justify-center w-full w-[100%]">
